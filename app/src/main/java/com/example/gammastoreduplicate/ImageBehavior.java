...
public class ImageBehavior extends CoordinatorLayout.Behavior<SelectableRoundedImageView> {
    ...
    @Override
    public boolean layoutDependsOn(CoordinatorLayout parent, SelectableRoundedImageView child, View dependency) {
//      return dependency instanceof CoordinatorLayout;
        return true;
    }

    @Override
    public boolean onDependentViewChanged(CoordinatorLayout parent, SelectableRoundedImageView child, View dependency) {
        ...
        if (expandedPercentageFactor < mChangeBehaviorPoint) {
            ...
            lp.width = (int) (mStartHeight - (heightToSubtract*2));
            lp.height = (int) (mStartHeight - (heightToSubtract*2));
...
//            Toast.makeText(mContext, "distancey subtrct: " +distanceYToSubtract, Toast.LENGTH_SHORT).show();
            CoordinatorLayout.LayoutParams lp = (CoordinatorLayout.LayoutParams) child.getLayoutParams();
    ...
    private void maybeInitProperties(SelectableRoundedImageView child, View dependency) {
    ...
    public int getStatusBarHeight() {
        ...
        Toast.makeText(mContext, "statusBar here", Toast.LENGTH_SHORT).show();
        if (resourceId > 0) {
